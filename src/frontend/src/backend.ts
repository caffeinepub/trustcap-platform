...
import type { Commodity as _Commodity, Company as _Company, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getCommodities(): Promise<Array<Commodity>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCommodities();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCommoditiesByCategory(): Promise<Array<Commodity>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCommoditiesByCategory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEquities(): Promise<Array<Company>> {
        if (this.processError) {
            try {
                const result = await this.actor.getEquities();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEquitiesBySector(): Promise<Array<Company>> {
        if (this.processError) {
            try {
                const result = await this.actor.getEquitiesBySector();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getInstrumentDetail(arg0: string): Promise<{
        __kind__: "company";
        company: Company;
    } | {
        __kind__: "commodity";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.getInstrumentDetail(arg0);
    ...
    async getMarketIndices(): Promise<Array<MarketIndex>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMarketIndices();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initializeStaticData(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.initializeStaticData();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
